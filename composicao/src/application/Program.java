...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		// Com base nos dados acima é possível instanciar um trabalhador
		...
		for (int i = 1; i <= n; i++) {
			...
			// Com os dados acima já tenho condições de instanciar um novo contrato
			HourContract contract = new HourContract(contractDate, valuePerHour, hours);
			
			// Associando o contract com o worker
