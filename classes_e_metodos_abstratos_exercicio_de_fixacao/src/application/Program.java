...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * 	arrecadado.
		 * 
		 * 	Os dados de pessoa física são: nome, renda anual e gastos com saúde. Os
		 * 	dados de pessoa jurídica são: nome, renda anual e número de funcionários.
		 ...
		 * 	teve gastos com saúde, 50% destes gastos são abatidos no imposto.
