...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Você deve faze um programa que realize o cadastro de uma conta, dando opção
		...
		Account account; // Instanciando a classe Account
