...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Fazer um programa que inicie com todos os dez quartos vazio, e depois leia
		 ...
		 * dos quartos ele escolheu (de 0 a 9). Suponha que seja escolhido um
		 * quarto vago. Ao final, seu programa deve imprimir um relatório de todas
		 * ocupações do pensionato por ordem de quarto.
		 */
		
		Scanner sc = new Scanner(System.in);
		
		Rent[] vect = new Rent[10]; // Declarando um vetor com a quantidade de quartos que serão alugados
